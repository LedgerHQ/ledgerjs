...
const cryptocurrenciesById: Record<string, CryptoCurrency> = {
    ...
    ethereum_classic: {
        ...
        explorerViews: [
            {
                tx:
                    "https://blockscout.com/etc/mainnet/tx/$hash/internal-transactions",
                address:
        ...
        explorerViews: [
            {
                ...
                address:
                    "https://chainz.cryptoid.info/pivx/address.dws?$address.htm",
            },
        ],
    },
    poa: {
        ...
        explorerViews: [
            {
                ...
                address:
                    "https://chainz.cryptoid.info/strat/address.dws?$address.htm",
            },
        ],
    },
    stealthcoin: {
        ...
        explorerViews: [
            {
                ...
                address:
                    "https://crypto.org/explorer/croeseid/account/$address",
            },
        ],
    },
}
