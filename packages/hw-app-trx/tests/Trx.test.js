...
test("getAppConfiguration", async () => {
  ...
  expect(result).toEqual({ allowData: true, allowContract: true, truncateAddress: true, version: "0.1.5", versionN: 105});
});
...
test("signPersonalMessage", async () => {
  ...
  expect(result).toEqual("af4fb6500ff9058835b564d43078d5b201b71a3d3ead0d113baf68c86199f5ef1ee8f6ea48016a991e9d4bff410b8a77ba604850a03ac5f9cfd5fd95e25842fc01");
});
